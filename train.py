...
lblr=tk.Label(window,image=photo,bg='black')
##root.wm_attributes('-transparentcolor','black')
lblr.place(x=0,y=0)
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System" ,bg='black' ,fg="white"  ,width=43  ,height=1,font=('times', 40, 'bold ')) 

message.place(x=20, y=65)
...
clearButton2.place(x=850, y=280)    
...
quitWindow.place(x=1000, y=480)
copyWrite = tk.Text(window, background=window.cget("background"), borderwidth=0,font=('times', 30, 'italic bold underline'))
copyWrite.tag_configure("superscript", offset=10)
copyWrite.insert("insert", "Developed by Rohit","", "TEAM", "superscript")
copyWrite.configure(state="disabled",fg="red"  )
copyWrite.pack(side="left")
copyWrite.place(x=700, y=730)
